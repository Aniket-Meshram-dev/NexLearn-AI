  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        {error && (
          <div className="alert alert-danger" style={{ padding: '8px 12px', fontSize: '0.82rem', marginBottom: 12, display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {requireOTP && (
            <div className="form-group animate-slide-up">
              <label className="form-label" style={{ color: 'var(--primary)', fontWeight: 700, display: 'inline-flex', alignItems: 'center', gap: 6 }}>
