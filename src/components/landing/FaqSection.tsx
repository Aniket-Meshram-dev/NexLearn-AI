...
export default function FaqSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'The AI Mentor leverages standard Web Speech APIs and custom conversational prompts to allow you to talk directly to an expert tutor while reading your module notes, receiving verbal analogies and real-time guidance. You can even switch between 4 distinct teaching personas: Socrates, Ada, Maya, and Ethan.',
    },
    {
      q: 'How can employers or universities verify my certificate?',
      a: 'Every certificate generated by NexLearn includes a unique cryptographic Credential ID and an embedded QR code. Anyone—including recruiters, institutions, or hiring managers—can visit our public verification portal at /verify and enter the ID or scan the code to instantly verify authenticity in real-time.',
    },
    {
      q: 'Can I export official academic transcripts and study reports?',
      a: 'Yes! The Academic Reports suite tracks your cumulative quiz performance, study velocity, and skill radar. You can export an official, institutional-grade Academic Performance Transcript PDF with verified completion hashes anytime.',
    },
  ];
